...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tk8mlls.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tk8mlls.containers.anotherwebservice.com/
...
```
git clone git@github.com:WWG7211/container-tk8mlls.git
cd container-tk8mlls
```
...
```
docker attach container-tk8mlls
```
